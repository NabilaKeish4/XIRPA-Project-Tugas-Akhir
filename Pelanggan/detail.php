    ...
    <div class="flex-1 p-8 overflow-y-auto">
        <div class="max-w-4xl mx-auto my-8">
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <p class="text-xs font-bold text-brand-500 uppercase tracking-widest"><?= htmlspecialchars($produk['kategori'] ?? 'Tanaman Hias') ?></p>
                    ...
                    <a href="chat.php?produk=<?= urlencode($produk['nama_tanaman']) ?>" class="mt-3 w-full border border-gray-200 text-gray-700 hover:bg-gray-50 font-bold py-3 rounded-xl text-xs uppercase tracking-wider transition flex items-center justify-center gap-2">
                        💬 Tanya Admin tentang tanaman ini
                    </a>
                </div>
            </div>
        </div>
