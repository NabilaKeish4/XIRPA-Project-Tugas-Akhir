...
<body class="bg-[#F4F3EF] min-h-screen flex text-stone-800 overflow-x-hidden">
    ...
    <div class="hidden lg:flex lg:w-3/5 relative bg-cover bg-center flex-col justify-between p-12 overflow-hidden"
        ...
        <div class="max-w-lg z-10 space-y-6">
            <h1 class="text-5xl font-extrabold text-white leading-[1.15] tracking-tight">Selamat Datang Kembali!</h1>
            <p class="text-stone-200 text-sm leading-relaxed">
                Akses panel kontrol untuk mengelola pesanan, statistik penjualan, dan inventaris toko tanaman hias Anda.
            </p>
        </div>
    ...
    <div class="w-full lg:w-2/5 flex flex-col justify-between p-8 sm:p-14 lg:p-16 bg-[#F4F3EF] relative">
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-2 bg-stone-200/70 p-1 rounded-2xl">
                <a href="login.php" class="px-4 py-1.5 rounded-xl text-xs font-bold bg-white text-stone-800 shadow-sm">Masuk</a>
                <a href="register_customer.php" class="px-4 py-1.5 rounded-xl text-xs font-bold text-stone-500 hover:text-stone-800">Daftar</a>
            </div>
        </div>
        ...
        <div class="my-auto max-w-sm w-full mx-auto space-y-6">
            ...
            <form action="" method="POST" class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="email" required placeholder="admin@planthub.com"
            ...
            <div class="text-center pt-4 border-t border-stone-200/80">
                <p class="text-xs text-stone-500">
                    Belum memiliki akun?
                    <a href="register_customer.php" class="font-bold text-[#2E7D32] hover:underline">Daftar Akun Baru</a>
                </p>
            </div>
        </div>
